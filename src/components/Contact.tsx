      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "abishek.am@example.com", href: "mailto:abishek.am@example.com", color: "from-red-400 to-pink-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/abishek", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "#", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2026 Abishek AM. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
